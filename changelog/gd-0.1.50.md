...
- **Multi-Tile-Room Nav-Bug:** Fehlerhafte Registrierung von M�beln (Betten) in gedrehten R�umen (Portrait) behoben. Das Spiel griff versehentlich immer auf die M�bel des Landscape-Nodes zu, wodurch Betten physikalisch au�erhalb der R�ume (auf dem Flur) lagen und G�ste f�lschlicherweise durch W�nde auf den Flur schlafen geschickt wurden.
